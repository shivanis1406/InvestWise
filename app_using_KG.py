...
def demonstrate_rag(query, seed):
    ...
    ("Reliance Retail", "provides", "7.3 Lakh Employment Opportunities"),
    ("Reliance Industries", "commits", "₹5,791 Crore in CSR Initiatives Across India")
        ])
        sample_triples_3 = sorted([
